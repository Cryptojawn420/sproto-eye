    ...
    >
      ...
      {screen === "gameover" && (
        ...
        >
          ...
          <div style={{ position: "relative", margin: "15px 0" }}>
            ...
            {/* Character portrait with X eyes overlay */}
      ...
      {screen === "victory" && (
        ...
        >
          ...
          {/* Backpack with Sonic, Harry Potter, Obama, Bitcoin */}
          <svg
            width="280"
            height="240"
            viewBox="0 0 280 240"
          ...
          >
            ...
            {/* Sonic the Hedgehog */}
            {/* Body */}
            <ellipse cx="150" cy="145" rx="35" ry="40" fill="#1E90FF" />
            {/* Belly */}
            <ellipse cx="150" cy="155" rx="20" ry="25" fill="#FFD700" />
            {/* Head */}
            <circle cx="150" cy="105" r="30" fill="#1E90FF" />
            {/* Spikes */}
            <polygon points="120,90 90,85 115,100" fill="#1E90FF" />
            <polygon points="115,100 85,105 115,115" fill="#1E90FF" />
            <polygon points="115,115 90,125 120,125" fill="#1E90FF" />
            <polygon points="180,90 200,80 175,95" fill="#1E90FF" />
            {/* Eye area */}
            <ellipse cx="150" cy="100" rx="18" ry="12" fill="#FFFFEE" />
            {/* Eyes */}
            <ellipse cx="145" cy="100" rx="5" ry="7" fill="#111" />
            <ellipse cx="158" cy="100" rx="5" ry="7" fill="#111" />
            {/* Nose */}
            <ellipse cx="151" cy="112" rx="5" ry="4" fill="#111" />
            {/* Smile */}
            <path
              d="M140 118 Q151 125 162 118"
              stroke="#111"
              strokeWidth="2"
              fill="none"
            />
            {/* Ears */}
            <ellipse cx="125" cy="82" rx="6" ry="8" fill="#1E90FF" />
            <ellipse cx="175" cy="82" rx="6" ry="8" fill="#1E90FF" />
            {/* Gloves */}
            <circle cx="115" cy="150" r="10" fill="#FFF" />
            <circle cx="185" cy="150" r="10" fill="#FFF" />
            {/* Shoes */}
            <ellipse cx="135" cy="195" rx="15" ry="8" fill="#CC0000" />
            <rect x="130" y="190" width="15" height="4" fill="#FFF" />
            <ellipse cx="165" cy="195" rx="15" ry="8" fill="#CC0000" />
            <rect x="155" y="190" width="15" height="4" fill="#FFF" />
            ...
            {/* Small green triangle at bottom */}
            <polygon points="85,200 95,185 105,200" fill="#33AA33" />
          </svg>
